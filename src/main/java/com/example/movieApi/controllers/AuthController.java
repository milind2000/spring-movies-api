...
import com.example.movieApi.auth.service.AuthService;
import com.example.movieApi.auth.service.JwtService;
import com.example.movieApi.auth.service.RefreshTokenService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> refreshToken(@RequestBody RefreshTokenRequest refreshTokenRequest) {
        ...
        return ResponseEntity.ok(AuthResponse.create(accessToken,refreshToken.getRefreshToken()));
    }
}
